...
form do |f|
      ...
      f.has_many :sale_products do |order|
        ...
        # order.input :product, :as => "string", input_html: { onBlur: "javascript:salida(this), busquedaProducto(this)", onclick: "javascript:fondo(this)", id: "product", name: "product", :style => "background-color: #E6E6E6; width: 360px;"}
        # order.input :supplier, as: :hidden, input_html: {name: "inventory_json", id: "inventory_json", value: inventory.product.to_json}
