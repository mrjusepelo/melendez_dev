...
console.log($('#clients_sixmonth_json').val())

var object_json = JSON.parse($('#clients_sixmonth_json').val());
...
var dataset = [{ label: "Clientes de los últimos 6 meses", data: d1, color: "#5482FF" }];
