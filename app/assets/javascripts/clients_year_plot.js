...
console.log($('#clients_year_json').val())

var object_json = JSON.parse($('#clients_year_json').val());
...
var dataset = [{ label: "Clientes del último Año", data: d1, color: "#5482FF" }];
...
//         }
//     ]);
$.plot($("#placeholder_year"), dataset, options);
